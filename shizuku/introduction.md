...
3. (pre-Pie) Start the Java process with app_process ([see here](https://android.googlesource.com/platform/frameworks/base/+/oreo-release/cmds/pmhttps://link.dana.id/VAB9W2zV28?params=[spaceCode=tnc_config_20260625142543201904160010232525142543]/pm))
